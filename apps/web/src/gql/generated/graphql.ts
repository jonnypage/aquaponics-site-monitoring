...
export type AdminDeviceModel = {
  ...
  checkinIntervalSeconds: Scalars['Int']['output'];
  ...
  snapshotRequestedAt?: Maybe<Scalars['DateTime']['output']>;
  snapshotsEnabled: Scalars['Boolean']['output'];
  telemetryRequestedAt?: Maybe<Scalars['DateTime']['output']>;
...
export type Mutation = {
  ...
  requestAdminDeviceSnapshot: AdminDeviceModel;
  requestAdminDeviceTelemetry: AdminDeviceModel;
  requestSiteTelemetry: SiteModel;
...
export type MutationRequestAdminDeviceSnapshotArgs = {
  deviceId: Scalars['String']['input'];
};


export type MutationRequestAdminDeviceTelemetryArgs = {
  deviceId: Scalars['String']['input'];
};


export type MutationRequestSiteTelemetryArgs = {
  siteId: Scalars['String']['input'];
};
...
export type SiteModel = {
  ...
  sensorReporting: Array<SiteSensorReportingModel>;
  status: SiteStatus;
  telemetryRefreshPending: Scalars['Boolean']['output'];
};
...
export type UpdateAdminDeviceInput = {
  ...
  checkinIntervalSeconds?: InputMaybe<Scalars['Int']['input']>;
  deviceId: Scalars['String']['input'];
  expectedIntervalSeconds?: InputMaybe<Scalars['Int']['input']>;
  hasCamera?: InputMaybe<Scalars['Boolean']['input']>;
  name?: InputMaybe<Scalars['String']['input']>;
...
export type AdminDevicesQuery = { __typename?: 'Query', adminDevices: Array<{ __typename?: 'AdminDeviceModel', deviceId: string, name?: string | null, siteId?: string | null, lastSeenAt?: any | null, expectedIntervalSeconds: number, reportIntervalSeconds: number, snapshotIntervalSeconds: number, checkinIntervalSeconds: number, telemetryRequestedAt?: any | null, snapshotRequestedAt?: any | null, hasCamera: boolean, snapshotsEnabled: boolean, board?: string | null, createdAt: any, updatedAt: any, sensorReadings: Array<{ __typename?: 'AdminDeviceSensorReadingModel', sensorKey: string, sensorType: SensorType, displayName: string, unit: string, icon?: string | null, value?: number | null, takenAt?: any | null }> }> };
...
export type AdminDeviceQuery = { __typename?: 'Query', adminDevice: { __typename?: 'AdminDeviceModel', deviceId: string, name?: string | null, siteId?: string | null, lastSeenAt?: any | null, expectedIntervalSeconds: number, reportIntervalSeconds: number, snapshotIntervalSeconds: number, checkinIntervalSeconds: number, telemetryRequestedAt?: any | null, snapshotRequestedAt?: any | null, hasCamera: boolean, snapshotsEnabled: boolean, board?: string | null, pinMap?: any | null, createdAt: any, updatedAt: any, recentSnapshots: Array<{ __typename?: 'DeviceSnapshotModel', id: string, takenAt: any, imageUrl: string, byteSize: number }> } };
...
export type UpdateAdminDeviceMutation = { __typename?: 'Mutation', updateAdminDevice: { __typename?: 'AdminDeviceModel', deviceId: string, name?: string | null, siteId?: string | null, pinMap?: any | null, lastSeenAt?: any | null, expectedIntervalSeconds: number, reportIntervalSeconds: number, snapshotIntervalSeconds: number, checkinIntervalSeconds: number, telemetryRequestedAt?: any | null, snapshotRequestedAt?: any | null, hasCamera: boolean, snapshotsEnabled: boolean, board?: string | null, createdAt: any, updatedAt: any } };

export type RequestAdminDeviceTelemetryMutationVariables = Exact<{
  deviceId: Scalars['String']['input'];
}>;


export type RequestAdminDeviceTelemetryMutation = { __typename?: 'Mutation', requestAdminDeviceTelemetry: { __typename?: 'AdminDeviceModel', deviceId: string, telemetryRequestedAt?: any | null, snapshotRequestedAt?: any | null, updatedAt: any } };

export type RequestAdminDeviceSnapshotMutationVariables = Exact<{
  deviceId: Scalars['String']['input'];
}>;


export type RequestAdminDeviceSnapshotMutation = { __typename?: 'Mutation', requestAdminDeviceSnapshot: { __typename?: 'AdminDeviceModel', deviceId: string, telemetryRequestedAt?: any | null, snapshotRequestedAt?: any | null, updatedAt: any } };
...
export type GetSiteQuery = { __typename?: 'Query', getSite: { __typename?: 'SiteModel', id: string, name: string, role: Role, status: SiteStatus, lastUpdate?: any | null, latitude?: number | null, longitude?: number | null, pollIntervalSeconds: number, telemetryRefreshPending: boolean, sensorReporting: Array<{ __typename?: 'SiteSensorReportingModel', deviceId: string, deviceName?: string | null, sensorKey: string, sensorType: SensorType, model: string, enabled: boolean, displayName: string, unit: string, sortOrder: number, icon?: string | null }>, latestSnapshot?: { __typename?: 'DeviceSnapshotModel', id: string, deviceId: string, deviceName?: string | null, takenAt: any, imageUrl: string, byteSize: number } | null, recentSnapshots: Array<{ __typename?: 'DeviceSnapshotModel', id: string, deviceId: string, deviceName?: string | null, takenAt: any, imageUrl: string, byteSize: number }> } };

export type GetSitesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSitesQuery = { __typename?: 'Query', getSites: Array<{ __typename?: 'SiteModel', id: string, name: string, role: Role, status: SiteStatus, lastUpdate?: any | null, latitude?: number | null, longitude?: number | null, pollIntervalSeconds: number, telemetryRefreshPending: boolean }> };
...
export type RequestSiteTelemetryMutationVariables = Exact<{
  siteId: Scalars['String']['input'];
}>;


export type RequestSiteTelemetryMutation = { __typename?: 'Mutation', requestSiteTelemetry: { __typename?: 'SiteModel', id: string, telemetryRefreshPending: boolean, lastUpdate?: any | null, status: SiteStatus } };
...
export const RequestAdminDeviceTelemetryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RequestAdminDeviceTelemetry"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"deviceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestAdminDeviceTelemetry"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"deviceId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"deviceId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deviceId"}},{"kind":"Field","name":{"kind":"Name","value":"telemetryRequestedAt"}},{"kind":"Field","name":{"kind":"Name","value":"snapshotRequestedAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<RequestAdminDeviceTelemetryMutation, RequestAdminDeviceTelemetryMutationVariables>;
export const RequestAdminDeviceSnapshotDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RequestAdminDeviceSnapshot"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"deviceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestAdminDeviceSnapshot"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"deviceId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"deviceId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deviceId"}},{"kind":"Field","name":{"kind":"Name","value":"telemetryRequestedAt"}},{"kind":"Field","name":{"kind":"Name","value":"snapshotRequestedAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<RequestAdminDeviceSnapshotMutation, RequestAdminDeviceSnapshotMutationVariables>;
...
export const RequestSiteTelemetryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RequestSiteTelemetry"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"siteId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestSiteTelemetry"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"siteId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"siteId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"telemetryRefreshPending"}},{"kind":"Field","name":{"kind":"Name","value":"lastUpdate"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<RequestSiteTelemetryMutation, RequestSiteTelemetryMutationVariables>;
